...
int main()
{
    ...
    // --------------------
    GLFWwindow* window = glfwCreateWindow(SCR_WIDTH, SCR_HEIGHT, "SkyAndShadow", NULL, NULL);
    if (window == NULL)
    {
    ...
    unsigned int groundTexture = loadTexture(FileSystem::getPath("resources/textures/ground.jpg").c_str());
